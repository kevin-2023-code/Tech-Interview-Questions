...
**6 writeups** on what each stage of the Perplexity loop actually is — the recruiter screen, the hiring-manager round, the culture interview, the project deep-dive. Read the one for the round you have next.
