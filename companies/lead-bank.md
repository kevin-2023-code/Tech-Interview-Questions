...
**1 writeup** filed under Lead Bank in the Study section — how a round runs, a problem worked end to end, or notes on the process. The *Topics* column says what it covers; open the one closest to what you have next.
...
**Practise these on TrueInterview.** Every title on this page — including every row of the table below — opens the full problem in a runnable workspace, judged server-side on the algorithm, low-level-design and SQL formats: [Lead Bank on TrueInterview](https://trueinterview.io/problems/company/lead-bank).
